...
class ScattDataForCefrScoring():
    ...
    def generate_default_data_ver_0_5(cls, author_id: str, author_name: str, created_at: datetime) -> dict:
        warnings.warn('`generate_default_data_ver_0_5` is deprecated.')
        scatt_data = dict()
        scatt_data['data_version'] = '0.5'
        scatt_data['timeline_data_set'] = dict()
    ...
    def convert_to_data_ver_0_5_for_cefr_scoring(cls, tsv_string: str, author_id: str, author_name: str, created_at: datetime) -> dict:
        warnings.warn('`convert_to_data_ver_0_5_for_cefr_scoring` is deprecated.')
    ...
    @classmethod
    def convert_to_data_ver_0_5_for_cefr_scoring_v2(cls, tsv_string: str, author_id: str, author_name: str, created_at: datetime) -> dict:
        from io import StringIO
...
def convert_to_data_for_cefr_scoring_from_elan_tsv_v2(
    ...
    if data_version == '0.5':
        return ScattDataForCefrScoring.convert_to_data_ver_0_5_for_cefr_scoring_v2(
            tsv_string,
            author_id,
            author_name,
            created_at,
